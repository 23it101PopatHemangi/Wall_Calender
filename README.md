...
> Designed not just as a UI, but as a **usable product** with real-world interactions and smooth user experience.
...
- Smart **date range highlighting (pill-style UI)**
- Clear distinction between:
  - Past dates (faded)
  - Today (highlighted)
  - Future dates (interactive)
